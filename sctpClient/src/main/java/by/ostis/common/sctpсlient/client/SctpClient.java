...
import by.ostis.common.sctpсlient.model.SctpRequest.SctpRequestHeader;
...
public class SctpClient implements ISctpClient {
	...
	public byte[] checkElement(ScAddress address) {
		...
		SctpRequestHeader header=request.new SctpRequestHeader(SctpCommandType.CHECK_ELEMENT,(byte)0, 0,4);
