...
public class SctpClientImpl implements SctpClient {
	...
	try {
	    response = this.sender.sendRequest(this.requestBuilder.buildRequest(RequestHeaderType.CHECK_ELEMENT,
		    address));
	...
	try {
	    response = sender.sendRequest(requestBuilder.buildRequest(
		    RequestHeaderType.SEARCH_ELEMENT_BY_IDENTIFIER, identifier));
	} catch (final TransportException e) {
	    // TODO Auto-generated catch block
	    e.printStackTrace();
	}
	...
	try {
	    // TODO need to test
	    response = this.sender.sendRequest(this.requestBuilder.buildRequest(RequestHeaderType.DELETE_ELEMENT,
		    address));
	} catch (final TransportException e) {
	...
	try {
	    // TODO need to test
	    response = this.sender.sendRequest(this.requestBuilder.buildRequest(RequestHeaderType.CREATE_SC_LINK));
	} catch (final TransportException e) {
	    // TODO handle exception
	    e.printStackTrace();
	}
	...
	try {
	    // TODO need to test
	    response = this.sender.sendRequest(this.requestBuilder.buildRequest(RequestHeaderType.SEARCH_SC_LINKS,
		    content));
	} catch (final TransportException e) {
	    // TODO handle exception
	    e.printStackTrace();
    ...
    @Override
    public SctpResponse setScRefContent(final ScAddress address, final ScString content) {
	SctpResponse response = new SctpResponse();
	try {
	    // TODO need to test
	    response = this.sender.sendRequest(this.requestBuilder.buildRequest(
		    RequestHeaderType.SET_SC_LINK_CONTENT, address, content));
	} catch (final TransportException e) {
	    // TODO handle exception
	    e.printStackTrace();
	}
    ...
    @Override
    public SctpResponse setSystemIdentifier(final ScAddress address, final ScString identifier) {
	SctpResponse response = new SctpResponse();
	try {
	    // TODO need to test
	    response = this.sender.sendRequest(this.requestBuilder.buildRequest(RequestHeaderType.SET_SYSIDTF,
		    address, identifier));
	} catch (final TransportException e) {
	    // TODO handle exception
	    e.printStackTrace();
