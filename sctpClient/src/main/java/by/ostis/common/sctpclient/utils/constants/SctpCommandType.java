...
public enum SctpCommandType {
	...
	UKNOWN_COMMAND(0x00), CHECK_ELEMENT_COMMAND(0x01), // check if specified sc-element
												// exist
	...
	ITERATE_CONSTRUCTION_COMMAND(0x0d), // return advanced template iteration
									// results
	EVENT_CREATE_COMMAND(0x0e), // create subscription to specified event
	EVENT_DESTROY_COMMAND(0x0f), // destroys specified event subscription
	EVENT_EMIT_COMMAND(0x10), // emits specified event to client
