...
public enum SctpCommandType {
	...
	UKNOWN_CMD(0x00), CHECK_ELEMENT_CMD(0x01), // check if specified sc-element
												// exist
	...
	ITERATE_CONSTRUCTION_CMD(0x0d), // return advanced template iteration
									// results
	...
	FIND_ELEMENT_BY_SYSIDTF_CMD(0xa0), // return sc-element by it system
										// identifier
