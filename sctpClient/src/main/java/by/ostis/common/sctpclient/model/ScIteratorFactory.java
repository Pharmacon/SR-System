...
public class ScIteratorFactory {
	public static  ScIterator create3FAA(ScParameter scAddress, ScParameter scElementTypeSecond, ScParameter scElementType){
		return new ScIterator().registerParameter(scAddress).registerParameter(scElementTypeSecond).registerParameter(scElementType);
	}
